...
public class Server implements Runnable {
            ...
            try {
                ...
                if(key.isAcceptable()) {
                    ...
                    try {
                        ...
                        // Expected during shutdown — server socket closes before the thread stops
                        chan = null;
                    } catch(Throwable t) {
    ...
    public boolean allowClient(UUID clientId) {
        // Allow if client has a valid key registered
        return clientMgr.getClientKey(clientId) != null;
    }
