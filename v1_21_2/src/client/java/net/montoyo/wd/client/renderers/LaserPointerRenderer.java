...
public final class LaserPointerRenderer implements IItemRenderer {
	...
	public void renderAfterVanilla(PoseStack poseStack, ItemStack is, float handSideSign, MultiBufferSource multiBufferSource, int packedLight, Matrix4f worldMatrix) {
		...
		RenderSystem.setShader(new ShaderProgram(ResourceLocation.withDefaultNamespace("core/position_color"), DefaultVertexFormat.POSITION_COLOR, ShaderDefines.EMPTY));
		...
		RenderSystem.setShader(new ShaderProgram(ResourceLocation.withDefaultNamespace("core/position_tex_color"), DefaultVertexFormat.POSITION_TEX_COLOR, ShaderDefines.EMPTY));
	}
